...
**Read it as a page.** Three companion pages render the equations and figures properly:

- [Model description](https://claude.ai/code/artifact/0f1520a8-32b4-4487-9a68-03d87b83ca5f) —
  a short tour of what the model computes and why CO₂ forcing is logarithmic. Start here.
- [Reference](https://claude.ai/code/artifact/1541b757-cf18-4876-9613-a76d726d28a4) — this
  document as a navigable page, generated by `scripts/readme-to-html.js`.
- [CO₂ response](https://claude.ai/code/artifact/fea59591-79e5-434e-87a4-81e93a569259) — the
  forcing chart, with a hover readout and the full table of values.
