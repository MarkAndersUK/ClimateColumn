...
internal static class Co2ChartRenderer
{
        ...
        Co2ChartQuantity quantity)
    {
        ...
        // The band and g-point counts are deliberately not repeated here: they changed once
        // already and left this sentence stale. The exact resolution is on the page anyway, in
        // the reproduce command below, which comes from the sweep itself.
        sb.AppendLine("    <p class=\"lede\">Six molecules in spectral bands derived from " +
